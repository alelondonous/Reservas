...
export default function ListHistorialPC(props){

    const { nombreespacio, nomequipo, horaini, horafin, fecha, programa,cabemov, setNombrelugar, setNompc, setHoraIni, setHoraFin, setfecha,setprograma, setModalVisible,setrealoadPrograma, setSeleccionopc,setCabecera } = props;
